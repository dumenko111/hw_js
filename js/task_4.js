...
const orderedDroid = function (value) {
    totalPrice = value * pricePerDroid;
    if (value === null) {
        return 'cancell customer'
    } else if (totalPrice >= credits) {
        return 'Недостаточно средств на счету!'
    } else 
        credits = credits - totalPrice
    return `Вы купили ${value} дроидов, на счету осталось ${credits} кредитов.`
}
console.log(orderedDroid(prompt('How much Droid you need ?')))
// Задание 4
